...
class ElementInvocationHandler(
    ...
    override fun invoke(proxy: Any, method: Method, args: Array<out Any>?): Any? {
        ...
        return try {
            when {
                elementType canBeAssignedTo WebElement::class -> method.invoke(element, *args.orEmpty())
                else ->
                    method.invoke(createElement(elementType as Class<out Element>, element), *args.orEmpty())
            }
        } catch (e: InvocationTargetException) {
            throw InvocationTargetException(Exception("Cannot invoke ${method.name} on $elementType $element"))
        }
